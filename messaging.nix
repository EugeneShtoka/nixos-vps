...
let
  ...
  mx-proxy = pkgs.buildGoModule {
    ...
    src = pkgs.fetchFromGitHub {
      owner  = "EugeneShtoka";
      repo   = "mx-proxy";
      rev    = "21111826a3af3700f198e7e621b2f4de3daa2b79";
      hash   = "sha256-ZkYW18sK9IasDeX5mTgu95+LaavsfRLQP00cEARzxKA=";
    };
  ...
  spammers = [
    "!J6UxaDDOI4slTuFUBM:matrix.cloud-surf.com" # #tipmaster-settlements- (Slack/TipMaster)
  ];
